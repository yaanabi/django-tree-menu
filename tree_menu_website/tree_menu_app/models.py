...
class MenuItem(models.Model):
    ...
    named_url = models.CharField(verbose_name='Named URL link to menu item content', max_length=255, null=True, blank=True)
    ...
    def __str__(self):
        return f"'{self.name}' menu item for '{self.menu.name}' with parent '{getattr(self.parent, 'name', None)}'"